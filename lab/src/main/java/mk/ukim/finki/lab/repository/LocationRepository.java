...
public class LocationRepository {
    ...
    public LocationRepository() {
        this.locations = List.of(
                new Location("Kavadarci", "Leninova 13", 50L, "Vintage house that a big intellectual was born!"),
                ...
                new Location("Kavadarci", "Disanska", 300L, "Big elegant restaurant located in the park!"),
